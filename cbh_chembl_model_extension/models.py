...
if "django_webauth" in settings.INSTALLED_APPS:
    ...
    def email_new_user(sender, **kwargs):
        if kwargs["created"]:  # only for new users
            ...
            new_user_name = '%s %s' % (sender.first_name, sender.last_name)
            ...
            send_mail('Welcome to ChemReg', welcome_message, email_from, sender.email, fail_silently=False, html_message=html_welcome_message)
