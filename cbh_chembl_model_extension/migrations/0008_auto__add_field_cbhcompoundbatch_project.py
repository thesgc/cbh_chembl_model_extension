...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CBHCompoundBatch.project'
        db.add_column(u'cbh_chembl_model_extension_cbhcompoundbatch', 'project',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['cbh_chembl_model_extension.Project'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CBHCompoundBatch.project'
        db.delete_column(u'cbh_chembl_model_extension_cbhcompoundbatch', 'project_id')
