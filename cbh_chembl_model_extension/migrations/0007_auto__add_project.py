...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'cbh_chembl_model_extension_project', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(default=None, max_length=50, null=True, db_index=True, blank=True)),
            ('project_key', self.gf('django.db.models.fields.SlugField')(default=None, max_length=50, unique=True, null=True, blank=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal(u'cbh_chembl_model_extension', ['Project'])


    def backwards(self, orm):
        # Deleting model 'Project'
        db.delete_table(u'cbh_chembl_model_extension_project')
